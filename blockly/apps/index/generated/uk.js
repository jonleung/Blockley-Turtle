...
appsIndex.start = function(opt_data, opt_ignored) {
  return appsIndex.messages(null) + '<table><tr><td><h1><span id="title">Програми Blockly</span></h1></td><td class="farSide"><select id="languageMenu"></select></td></tr><tr><td>Блоклі - це графічне середовище програмування. Нижче наведені приклади додатків, що використовують Блоклі.</td></tr></table><table><tr><td><a href="puzzle/index.html"><img src="index/puzzle.png" height=80 width=100></a></td><td><div><a href="puzzle/index.html">Головоломка</a></div><div>Навчіться використовувати Blockly в інтерфейсі.</div></td></tr><tr><td><a href="maze/index.html"><img src="index/maze.png" height=80 width=100></a></td><td><div><a href="maze/index.html">Лабіринт</a></div><div>Використовуйте Блоклі, щоб пройти лабіринт.</div></td></tr><tr><td><a href="turtle/index.html"><img src="index/turtle.png" height=80 width=100></a></td><td><div><a href="turtle/index.html">Графіка Черепахи</a></div><div>Використовуйте Blockly, щоб малювати.</div></td></tr><tr><td><a href="code/index.html"><img src="index/code.png" height=80 width=100></a></td><td><div><a href="code/index.html">Код</a></div><div>Експортувати Blockly програму на JavaScript, Python або XML.</div></td></tr></table><p><span id="footer_prefix"></span><a href="http://blockly.googlecode.com/">blockly.googlecode.com</a><span id="footer_suffix"></span>';
};
