...
appsIndex.messages = function(opt_data, opt_ignored) {
  return apps.messages(null) + '<div style="display: none"><span id="indexTitle">ブロックリーのアプリ</ span><span id="indexFooter">ブロックリーはフリーでありオープンソースです。ブロックリーのコードや翻訳に貢献、またはブロックリーを自分のアプリに使用するには、%1 を参照してください。<span></div>';
};


appsIndex.start = function(opt_data, opt_ignored) {
  return appsIndex.messages(null) + '<table><tr><td><h1><span id="title">ブロックリーのアプリ</span></h1></td><td class="farSide"><select id="languageMenu"></select></td></tr><tr><td>ブロックリーはグラフィカルなプログラミング環境です。以下に列挙したサンプル アプリケーションはブロックリーを使用しています。</td></tr></table><table><tr><td><a href="puzzle/index.html"><img src="index/puzzle.png" height=80 width=100></a></td><td><div><a href="puzzle/index.html">パズル</a></div><div>ブロックリーのインターフェイスの使い方を学びましょう。</div></td></tr><tr><td><a href="maze/index.html"><img src="index/maze.png" height=80 width=100></a></td><td><div><a href="maze/index.html">迷路</a></div><div>ブロックリーで迷路を解きましょう。</div></td></tr><tr><td><a href="turtle/index.html"><img src="index/turtle.png" height=80 width=100></a></td><td><div><a href="turtle/index.html">タートル グラフィックス</a></div><div>ブロックリーで描きましょう。</div></td></tr><tr><td><a href="code/index.html"><img src="index/code.png" height=80 width=100></a></td><td><div><a href="code/index.html">コード</a></div><div>ブロックリーのプログラムを JavaScript、Python、XML にエクスポートしましょう。</div></td></tr></table><p><span id="footer_prefix"></span><a href="http://blockly.googlecode.com/">blockly.googlecode.com</a><span id="footer_suffix"></span>';
};
